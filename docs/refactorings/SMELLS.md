...
| SM-003 | Large Class — 332 lines, over the constitution's 250 hard limit | `components/scrolly/PackScrolly.tsx` | logged, 0001 · nothing scheduled edits it |
| SM-004 | Four components in one file, against the constitution's one-per-file rule; 317 lines | `components/three/PackStage.tsx` | logged, 0001 · nothing scheduled edits it |
