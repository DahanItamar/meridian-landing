...
| ~~SM-005~~ | Large Class — 173 lines, over the 150 soft limit | `components/brand/BeansLoader.tsx` | ~~won't fix~~ · **gone 2026-08-21** — resolved as a side effect, not as refactoring work. The 160 lines of generated SVG path data left with the LottieFiles asset when it was replaced over its licence; the original that took its place is 65 lines. |
